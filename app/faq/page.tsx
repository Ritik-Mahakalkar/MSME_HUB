...
import BreadcrumbBannerImage from '@/public/img/banner/faq.avif';
import BreadcrumbBannerImageTablet from '@/public/img/banner/faq.avif';
import BreadcrumbBannerImageMobile from '@/public/img/banner/faq.avif';
