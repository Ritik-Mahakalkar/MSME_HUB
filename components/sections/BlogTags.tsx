...
//                                 </div>
//                             </div>
//                             <div className="col-span-12 lg:col-span-4"  style={{ width: "94%", float: "right" }}>
//                                 <BlogSidebar />
//                             </div>
//                         </div>
//                     </>
...
const BlogTags = ({ slug }: { slug: string }) => {
  ...
  posts = posts.filter((post) =>
    Array.from(post.tags.map((tag) => createHandle(tag))).includes(slug)
  );
        ...
        {posts.length > 0 ? (
          <>
            ...
            >
              ...
              {/* ✅ Sidebar - Takes 30% and is sticky */}
              <div
